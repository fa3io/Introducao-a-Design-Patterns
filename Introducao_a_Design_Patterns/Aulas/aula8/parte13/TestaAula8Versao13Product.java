package aula8.parte13;



import aula8.parte13.integracao.ProductDAO;
import aula8.parte13.integracao.JPAFactory;
import aula8.parte13.integracao.Factory;
import aula8.parte13.entidades.Product;
import java.util.ArrayList;
import java.util.List;

public class TestaAula8Versao13Product {
    
    Factory factory = new JPAFactory();
    private final ProductDAO productDAO  = factory.createProductDAO();
    private static List<Product> products = new ArrayList<>();

    public TestaAula8Versao13Product() {
    ...
    public static void main(String[] args) {
        ...
        TestaAula8Versao13Product teste = new TestaAula8Versao13Product();
