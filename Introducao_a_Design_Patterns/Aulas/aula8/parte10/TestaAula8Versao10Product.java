...
public class TestaAula8Versao10Product {
    
    private final ProductDAO productDAO  = ConcreateFactory.createProductDAO();
    private static List<Product> products = new ArrayList<>();

    public TestaAula8Versao10Product() {
    ...
    public static void main(String[] args) {
        ...
        TestaAula8Versao10Product teste = new TestaAula8Versao10Product();
