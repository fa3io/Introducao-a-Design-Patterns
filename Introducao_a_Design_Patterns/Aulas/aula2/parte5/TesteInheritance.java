...
public class TesteInheritance {
	...
	public static void  main(String[] args){
		...
		System.out.println("----------------------------------------------------------");
		System.out.println("NOVA ABORDAGEM FLOWCONTAINER");
		System.out.println("----------------------------------------------------------");
		
Container flowEtchednNovo = new FlowContainerEtchedBorder();
		
		
		
		flowEtchednNovo.add(RadioButton1);
		flowEtchednNovo.add(menuBar1);
		flowEtchednNovo.add(label1);
		flowEtchednNovo.add(checkBox);
		flowEtchednNovo.doLayout();
		
		Container flowSolidNovo = new FlowContainerSolidBorder();
		
		
		
		flowSolidNovo.add(RadioButton1);
		flowSolidNovo.add(menuBar1);
		flowSolidNovo.add(label1);
		flowSolidNovo.add(checkBox);
		flowSolidNovo.doLayout();
		
		
		System.out.println("----------------------------------------------------------");
		System.out.println("NOVA ABORDAGEM  GRIDCONTAINER");
		System.out.println("----------------------------------------------------------");
		
		
		
		Container gridEtchedNovo = new GridContainerEtchedBorder(2, 2);
		
		gridEtchedNovo.add(RadioButton1);
		gridEtchedNovo.add(menuBar1);
		gridEtchedNovo.add(label1);
		gridEtchedNovo.add(checkBox);
		gridEtchedNovo.doLayout();
		
		Container gridSolidNovo = new GridContainerSolidBorder(2, 2);
		
		gridSolidNovo.add(RadioButton1);
		gridSolidNovo.add(menuBar1);
		gridSolidNovo.add(label1);
		gridSolidNovo.add(checkBox);
		gridSolidNovo.doLayout();
