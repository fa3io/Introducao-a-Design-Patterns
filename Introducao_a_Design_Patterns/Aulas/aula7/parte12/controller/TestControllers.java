...
public class TestControllers {
	...
	private static void testingRegister() {
		...
		System.out
				.println("Teste de Integracao do Register Controller com ItauTec Inventory System");
		register.createInventoryAdpter("ItauTec");
		register.decreaseItemQuantity();
		System.out.println("");

		System.out
				.println("Teste de Integracao do Register Controller com IBM Inventory System");
		register.createInventoryAdpter("IBM");
		register.decreaseItemQuantity();
		System.out.println("");

		System.out
				.println("Teste de Integracao do Register Controller com SAP Inventory System");
		register.createInventoryAdpter("SAP");
		register.decreaseItemQuantity();
		System.out.println("");

		System.out
				.println("Teste de Integracao do Register Controller com ItauTec  Account System");
		register.createAccountAdpter("ItauTec");
		register.registerSaleAccountSystem();
		System.out.println("");

		System.out
				.println("Teste de Integracao do Register Controller com IBM  Account System");
		register.createAccountAdpter("IBM");
		register.registerSaleAccountSystem();
		System.out.println("");

		System.out
				.println("Teste de Integracao do Register Controller com SAP  Account System");
	...
	private static void testingInventoryController() {
		...
		System.out
				.println("Teste de Integracao do AccountController com ItauTec Account System");
		inventoryController.createInventoryAdpter("ItauTec");
		inventoryController.UpdateInventory();
		System.out.println("");

		System.out
				.println("Teste de Integracao do AccountController com IBM Account System");
		inventoryController.createInventoryAdpter("IBM");
		inventoryController.UpdateInventory();
		System.out.println("");

		System.out
				.println("Teste de Integracao do AccountController com SAP Account System");
